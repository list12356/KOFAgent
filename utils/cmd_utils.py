...
def cmd_arg_parser():
    ...
    parser.add_argument("--frame_ratio", default=3, type=int)
    ...
    parser.add_argument("--explore_scale", default=0.1, type=float)
    ...
    parser.add_argument("--restore_path", default='./saved_models/')
    return parser